    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variants
          variant === 'primary' &&
            'bg-primary text-primary-foreground shadow-hard-sm shadow-hard-active hover:bg-[var(--primary-hover)] transition-colors duration-150',
          variant === 'secondary' &&
          ...
          variant === 'destructive' &&
            'bg-destructive text-destructive-foreground hover:bg-[var(--destructive-hover)] transition-colors duration-150',
          // Sizes
